...
from transitive_closure.transitive_closure import transitive_closure_dag
...
def sparse_rc_sem(W, n, sparsity=0.3, std=0.0, noise_type='none', noise_effect='both', semiring='plus-mul'):
    """
    ...
    #transitive closure
    W_tc = transitive_closure_dag(W, semiring=semiring)
    X = (C + Nf) @ (W_tc + I) +  Ns
